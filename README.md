...
**On first install** you need to allow access for MTMR in Accessibility otherwise buttons like <kbd>Esc</kbd> Volume/Brightness and another system keys won't function
